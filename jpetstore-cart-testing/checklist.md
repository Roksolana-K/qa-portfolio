...
|----|----------------------------------------------------------------------|------------|-------------|----------|-----------------------------------------------------|
| 1  | Cart is accessible from any page                                     | High       | ❌ Failed   | [PS-001](https://github.com/Roksolana-K/manual-qa-portfolio/blob/main/jpetstore-cart-testing/bug_reports.md#-ps-001---cart-is-not-accessible-from-faq-page)   | Not accessible from “FAQ” page                      |
| 2  | Cart icon has tooltip “Cart”                                         | Low        | ❌ Failed   | [PS-002](https://github.com/Roksolana-K/manual-qa-portfolio/blob/main/jpetstore-cart-testing/bug_reports.md#-ps-002---cart-has-no-tooltip)   | Tooltip missing                                     |
| 3  | When a product is added, all info about it is shown in a table with columns: Item ID, Product ID, Name, Description, In Stock?, Quantity, List Price, Total Cost   | Medium     | ❌ Failed   | [PS-003](https://github.com/Roksolana-K/manual-qa-portfolio/blob/main/jpetstore-cart-testing/bug_reports.md#-ps-003---shopping-cart-table-missing-name-column)   | Missing “Name” column                               |
...
| 13 | If at least 1 product in the cart: it should be displayed as a badge with a quantity of added to the Cart products on the Cart’s icon                              | Low       | ❌ Failed  | [PS-004](https://github.com/Roksolana-K/manual-qa-portfolio/blob/main/jpetstore-cart-testing/bug_reports.md#-ps-004---cart-icon-badge-with-product-amount-not-displayed)   | No badge displayed |
...
| 21 | "Quantity" field in the Cart should not accept negative numbers                                | Medium    | ❌ Failed  | [PS-005](https://github.com/Roksolana-K/manual-qa-portfolio/blob/main/jpetstore-cart-testing/bug_reports.md#-ps-005---shopping-cart-quantity-field-accepts-negative-numbers)   | Field accepts negative number (clears cart) |
| 22 | User should be able to add 5 items of the same product                                   | Critical  | ✅ Passed  |          |          |
| 23 | User should not be able to add more than 5 items of the same product                               | Medium    | ❌ Failed  | [PS-006](https://github.com/Roksolana-K/manual-qa-portfolio/blob/main/jpetstore-cart-testing/bug_reports.md#-ps-006---user-can-add-more-than-5-items-of-the-same-product)   | No restriction |
